...
public class async_add_products extends AsyncTask<String,Void,String> {
    StringBuffer buffer;
    Context context;
    HttpURLConnection connection;
    String id, name, catagory, quantity, price, weight, image;

    public async_add_products(Context context) {
